  ...
  constructor() {
    ...
    this.waves = [
      ...
      },
      {
        level: 81,
        enemies: [{ oldType: BeetlemorphOne, newType: Boss1, count: 1 },
          { oldType: BeetlemorphOne, newType: Boss2, count: 1 },
          { oldType: BeetlemorphTwo, newType: Boss3, count: 1 },
          { oldType: BeetlemorphTwo, newType: Boss4, count: 1 },
          { oldType: RhinomorphTwo, newType: Boss5, count: 1 },
          { oldType: RhinomorphTwo, newType: Boss6, count: 1 },
          { oldType: LocustmorphOne, newType: Boss7, count: 1 },
          { oldType: LocustmorphOne, newType: LocustmorphTwo, count: 1 }],
        toActivate: [Boss3, LocustmorphTwo, PhantommorphThree, MantismorphTwo, EaglemorphFour, SquidmorphOne],
        pointsRequired: 500,
        isBossCheck: false,
      },
    ];
