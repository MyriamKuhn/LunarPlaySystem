...
export class AudioControl {
  constructor() {
    ...
    this.audioFiles = {
      charge: '/assets/audio/cryos/charge.mp3',
      flap1: '/assets/audio/cryos/flap1.mp3',
      flap2: '/assets/audio/cryos/flap2.mp3',
      flap3: '/assets/audio/cryos/flap3.mp3',
      flap4: '/assets/audio/cryos/flap4.mp3',
      flap5: '/assets/audio/cryos/flap5.mp3',
      win: '/assets/audio/cryos/winflappy.mp3',
      lose: '/assets/audio/cryos/loseflappy.mp3',
    };
