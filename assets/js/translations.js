export const descriptions = {
  fr: {
    ...
    ringuara: {
      intro: "Ringuara est une planète énigmatique, entourée de ses célèbres anneaux d'énergie qui délimitent de vastes labyrinthes cristallins. Ces anneaux scintillants tracent les contours de territoires mystérieux et fascinants, attirant aventuriers et explorateurs. La planète est un mélange d'environnements spectaculaires, avec ses lacs de méthane et ses créatures aériennes qui vivent en harmonie dans un écosystème unique. Les labyrinthes de Ringuara sont à la fois un défi et une merveille, cachant des trésors et des dangers dans chaque recoin.",
      desc: "Dans Ringuara Maze Masters, vous incarnez un habitant de la planète, utilisant des ruses pour tromper les ennemis. Chaque niveau propose un labyrinthe complexe, délimité par les anneaux d'énergie de Ringuara. Vous devrez éliminer tous les ennemis en utilisant des bombes stratégiquement placées pour progresser à travers des vagues successives. Avec chaque vague, les défis deviennent plus intenses, nécessitant une combinaison de tactique et de réflexes pour survivre et dominer le labyrinthe. Collectez des points et des météorites pour augmenter votre score et prouver votre maîtrise du terrain.",
      game: "Ringuara Maze Masters",
      link: "/fr/ringuara/",
    },
    lunarplay: {
  ...
  en: {
    ...
    ringuara: {
      intro: "Ringuara is an enigmatic planet, surrounded by its famous energy rings that outline vast crystalline labyrinths. These glittering rings trace the contours of mysterious and fascinating territories, attracting adventurers and explorers alike. The planet is a blend of spectacular environments, with methane lakes and aerial creatures living in harmony in a unique ecosystem. The labyrinths of Ringuara are both a challenge and a wonder, hiding treasures and dangers in every nook and cranny.",
      desc: "In Ringuara Maze Masters, you take on the role of a planet dweller, using trickery to outwit enemies. Each level features a complex maze, bounded by Ringuara's energy rings. You must eliminate all enemies using strategically placed bombs to progress through successive waves. With each wave, the challenges become more intense, requiring a combination of tactics and reflexes to survive and dominate the maze. Collect points and meteorites to increase your score and prove your mastery of the terrain.",
      game: "Ringuara Maze Masters",
      link: "/en/ringuara/",
    },
    lunarplay: {
  ...
  de: {
    ...
    ringuara: {
      intro: "Ringuara ist ein rätselhafter Planet, der von seinen berühmten Energieringen umgeben ist, die ausgedehnte kristalline Labyrinthe begrenzen. Diese glitzernden Ringe zeichnen die Umrisse mysteriöser und faszinierender Gebiete nach und ziehen Abenteurer und Entdecker an. Der Planet ist eine Mischung aus spektakulären Umgebungen mit Methanseen und Luftkreaturen, die in einem einzigartigen Ökosystem harmonisch zusammenleben. Die Labyrinthe von Ringuara sind Herausforderung und Wunder zugleich und verbergen in jedem Winkel Schätze und Gefahren.",
      desc: "In Ringuara Maze Masters schlüpfst du in die Rolle eines Bewohners des Planeten und nutzt Tricks, um deine Feinde zu täuschen. Jedes Level bietet ein komplexes Labyrinth, das von Ringuaras Energieringen begrenzt wird. Du musst alle Feinde mit strategisch platzierten Bomben ausschalten, um durch aufeinanderfolgende Wellen voranzukommen. Mit jeder Welle werden die Herausforderungen intensiver und erfordern eine Kombination aus Taktik und Reflexen, um zu überleben und das Labyrinth zu beherrschen. Sammle Punkte und Meteoriten, um deine Punktzahl zu erhöhen und zu beweisen, dass du das Spielfeld beherrschst.",
      game: "Ringuara Maze Masters",
      link: "/de/ringuara/",
    },
    lunarplay: {
