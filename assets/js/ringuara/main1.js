class Pacman extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("pacman tileset", "/assets/img/ringuara/tileset.png");
    this.load.tilemapTiledJSON("map", "/assets/img/ringuara/pacman-map.json");
    this.load.spritesheet(
      "pacman",
      "/assets/img/ringuara/pacman0.png",
      { frameWidth: 32, frameHeight: 32 }
    );
    this.load.spritesheet(
      "pacman1",
      "/assets/img/ringuara/pacman1.png",
      { frameWidth: 32, frameHeight: 32 }
    );
    this.load.spritesheet(
      "pacman2",
      "/assets/img/ringuara/pacman2.png",
      { frameWidth: 32, frameHeight: 32 }
    );
    this.load.spritesheet(
      "pacman3",
      "/assets/img/ringuara/pacman3.png",
      { frameWidth: 32, frameHeight: 32 }
    );
    this.load.spritesheet(
      "pacman4",
      "/assets/img/ringuara/pacman4.png",
      { frameWidth: 32, frameHeight: 32 }
    );

    this.load.spritesheet(
      "pacmanDeath1",
      "/assets/img/ringuara/spr_pacdeath_0.png",
      { frameWidth: 32, frameHeight: 32 }
    );
    this.load.spritesheet(
      "pacmanDeath2",
      "/assets/img/ringuara/spr_pacdeath_1.png",
      { frameWidth: 32, frameHeight: 32 }
    );
    this.load.spritesheet(
      "pacmanDeath3",
      "/assets/img/ringuara/spr_pacdeath_2.png",
      { frameWidth: 32, frameHeight: 32 }
    );

    this.load.image("dot", "/assets/img/ringuara/dot.png");
    this.load.image("powerPill", "/assets/img/ringuara/spr_power_pill_0.png");

    this.load.spritesheet(
      "pinkGhost",
      "/assets/img/ringuara/spr_ghost_pink_0.png",
      { frameWidth: 32, frameHeight: 32 }
    );
    this.load.spritesheet(
      "orangeGhost",
      "/assets/img/ringuara/spr_ghost_orange_0.png",
      { frameWidth: 32, frameHeight: 32 },
    );
    this.load.spritesheet(
      "blueGhost",
      "/assets/img/ringuara/spr_ghost_blue_0.png",
      { frameWidth: 32, frameHeight: 32 }
    );
    this.load.spritesheet(
      "redGhost",
      "/assets/img/ringuara/spr_ghost_red_0.png",
      { frameWidth: 32, frameHeight: 32 }
    );
    this.load.spritesheet(
      "scaredGhost",
      "/assets/img/ringuara/spr_afraid_0.png",
      { frameWidth: 32, frameHeight: 32 }
    );
    this.load.spritesheet(
      "scaredGhostWhite",
      "/assets/img/ringuara/spr_afraid_1.png",
      { frameWidth: 32, frameHeight: 32 }
    );

    this.load.image("endGameImage", "/assets/img/ringuara/spr_message_2.png");
    this.load.image("lifeCounter1", "/assets/img/ringuara/spr_lifecounter_0.png");
    this.load.image("lifeCounter2", "/assets/img/ringuara/spr_lifecounter_0.png");
  }
