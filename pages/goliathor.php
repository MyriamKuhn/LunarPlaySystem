...
<head>
	...
	<link rel="alternate" href="<?= $requestScheme . '://' . $serverName . '/fr/goliathor/' ?>" hreflang="fr" />
	<link rel="alternate" href="<?= $requestScheme . '://' . $serverName . '/en/goliathor/' ?>" hreflang="en" />
	<link rel="alternate" href="<?= $requestScheme . '://' . $serverName . '/de/goliathor/' ?>" hreflang="de" />
	<link rel="canonical" href="<?= $requestScheme . '://' . $serverName . '/' . Security::secureInput($lang) . '/goliathor/' ?>" />
	<link rel="alternate" href="<?= $requestScheme . '://' . $serverName . '/en/goliathor/' ?>" hreflang="x-default" />
	<!-- Meta pour le SEO -->
