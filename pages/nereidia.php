...
<head>
	...
	<link rel="alternate" href="<?= $requestScheme . '://' . $serverName . '/fr/nereidia/' ?>" hreflang="fr" />
	<link rel="alternate" href="<?= $requestScheme . '://' . $serverName . '/en/nereidia/' ?>" hreflang="en" />
	<link rel="alternate" href="<?= $requestScheme . '://' . $serverName . '/de/nereidia/' ?>" hreflang="de" />
	<link rel="canonical" href="<?= $requestScheme . '://' . $serverName . '/' . Security::secureInput($lang) . '/nereidia/' ?>" />
	<link rel="alternate" href="<?= $requestScheme . '://' . $serverName . '/en/nereidia/' ?>" hreflang="x-default" />
	<!-- Meta pour le SEO -->
